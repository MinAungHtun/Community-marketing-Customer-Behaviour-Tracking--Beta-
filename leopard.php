...
$_SESSION['count']=1; 
include("COnnectionstring.php");
$query="Select * from leopard l, origin o, area a, country c where l.LeopardID=o.LeopardID and o.AreaID=a.AreaID and a.CountryID=c.CountryID  order by l.LeopardID ASC;";
$ret=mysqli_query($connection,$query);
$mm="Select * from adoption";
$aa=mysqli_query($connection,$mm);
$ff=mysqli_fetch_assoc($aa);
$tt=$ff['LeopardID'];
?>
<!DOCTYPE html>
<html >
...
<body>
  <nav class="navbar navbar-light mbr-navbar navbar-transparent navbar-fixed-top" id="menu-m" data-rv-view="213">
    <div class="container">
...
<section class="mbr-section mbr-section-small mbr-after-navbar" id="msg-box1-1a" data-rv-view="219" style="background-color: rgb(255, 248, 224); padding-top: 4.5rem; padding-bottom: 4.5rem;">
    ...
    <div class="container">
        <div class="row">
            ...
            <div>
                ...
                <div class="col-sm-8">
                    <h2 class="mbr-section-title h1">Be cool!</br> Adopt a leopard</h2>
...
<section class="mbr-section mbr-section__container mbr-section__container--isolated" id="content1-21" data-rv-view="387">
    <div class="container">
        <h3 style="text-align: center; margin-bottom: 100px; color:#CDBE70; " class="mbr-section-title h1">Leopards currently at SAL</h3>
        <?php 
        if(mysqli_num_rows($ret)>0)
        {
         ...
         ?>
         <div class="col-md-4">
          <div style="background-color: rgb(255, 248, 224); border-width: : 30%; text-align: center; margin-top:50px; height: 400px;">
            <img src="images/<?php echo $row['Photo']; ?>" class="img-responsive" style="padding-left: 5%; padding-top: 7%;"/><br/>
            <h4  style="color:#CDBE70; padding-top: 5%;">Name: <?php echo $row['LeopardName']; ?></h4>
            <h4  style="color:#CDBE70;">Area: <?php echo $row['AreaName']; ?></h4>
            <h4  style="color:#CDBE70;">Country: <?php echo $row['CountryName']; ?></h4>
            <?php if ($tt==$row['LeopardID']) { ?><p style="color:#FF7F50;">Not available for adoption</p><?php }elseif ($tt!=$row['LeopardID']) {
               ?><a href="leodum.php?id=<?php echo $row['LeopardID'] ?>" style="color:#FF7F50;">Adopt</a><?php } ?>
         </div>
    </div>
  <?php }
  }
        ...
        <div>
            <div>
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="mbr-section carousel-item dark center mbr-section-full active" style="background-image: url(leopardimages/l7.jfif);">
                            ...
                            <div class=" container">
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-3 text-xs-right">
                                        <h2 class="mbr-section-title display-1">SL</h2>
                    ...
                    </div><div class="mbr-section carousel-item dark center mbr-section-full" style="background-image: url(leopardimages/l2.jfif);">
                        <div class="mbr-table-cell">
                            ...
                            <div class=" container">
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-1">
                                        <h2 class="mbr-section-title display-1">CT</h2>
                    ...
                    </div><div class="mbr-section carousel-item dark center mbr-section-full" style="background-image: url(leopardimages/l1.jfif);">
                        <div class="mbr-table-cell">
                            ...
                            <div class=" container">
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2 text-xs-center">
                                        <h2 class="mbr-section-title display-1">KL</h2>
...
<section class="mbr-section mbr-section-small" id="msg-box2-22" data-rv-view="388" style="background-color: rgb(255, 255, 255); padding-top: 4.5rem; padding-bottom: 4.5rem;">
    ...
    <div class="container">
        <div class="row">
            ...
            <div>
                ...
                <div class="col-sm-8">
                    <h2 class="mbr-section-title h1"> Leopards are cool. </br>Members are way cooler.</h2>
...
<section class="mbr-section mbr-section__container mbr-section__container--isolated" id="content1-23" data-rv-view="391">
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 lead"><p>Leopards represent mystery.</br>And a little bit of History and reflections.</p></div>
        </div>
    </div>
</section>

<section class="mbr-section mbr-section-small mbr-footer" id="contacts2-8" data-rv-view="234" style="background-color: rgb(55, 56, 62); padding-top: 3rem; padding-bottom: 0rem;">
...
<section class="mbr-section mbr-section-small" id="social-buttons2-1b" data-rv-view="222" style="background-color: rgb(55, 56, 62); padding-top: 1.5rem; padding-bottom: 0rem;">
...
<footer class="mbr-section mbr-section-nopadding mbr-footer" id="footer1-9" data-rv-view="224" style="background-color: rgb(55, 56, 62); padding-top: 1rem; padding-bottom: 0rem;">
