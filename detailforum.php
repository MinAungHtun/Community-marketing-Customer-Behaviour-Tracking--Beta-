...
$sql="SELECT ptitle, pcontent, pid, pauthor from forumtbl where FID=? and ptype='o'";
...
<tr>        <td><img src="22.png" width="50px"; height="50px;"></td>
</tr>      <tr>
      ...
      <tr>
        <td style="font-size:24px; padding-bottom: 50px; ">
          <?php
                $sl="Select * from pphoto where pid=$pid;";
                $rr=mysqli_query($connection,$sl);
                while ($uu=mysqli_fetch_array($rr)){
           ?>
          <img src="images/<?php echo $uu['photo'];?>"><?php }?>
        </td>
      </tr>
			<?php endwhile; ?>
			<?php else:
...
<p>This text will appear 1 months after deployment. IF you want to assign a post to an image first insert post data separately by hitting the button underneath it and then uploading a photo by hitting the button underneath it.</p>
...
</form><form method="post" action="L.php" enctype="multipart/form-data"style="text-align: center;margin-top: 200px;">
